...
GITHUB_BINARY_PINS: OrderedDict[str, tuple[str, str]] = OrderedDict(
    [
        ...
        ("SYFT", ("anchore/syft", "syft_{version}_linux_amd64.tar.gz")),
    ]
)
...
def write_uv_required_version(path: Path, version: str) -> None:
    path.write_text(
        "# Generated by scripts/update_dependencies.py.\n"
...
def refresh_devcontainer_dependencies() -> None:
    ...
    write_uv_required_version(UV_TOML, values["UV_VERSION"])
